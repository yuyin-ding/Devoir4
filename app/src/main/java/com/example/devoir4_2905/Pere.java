    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                Toast.makeText(Pere.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        searchPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Decouvrir = new Intent(Pere.this, Decouvrir.class);
        ...
        accueilPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Accueil = new Intent(Pere.this, Acceuil.class);
...
/*
        ...
        plusPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Plus = new Intent(Pere.this, Plus.class);
                startActivity(Plus);
            }
        });
